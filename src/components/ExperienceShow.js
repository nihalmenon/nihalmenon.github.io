...
function ExperienceShow() {
    ...
    const descriptions = ['I worked on the internal manager site, customer-facing website, and the warehouse app for a biotechnology company with a worldwide presence. I’ve led transformative projects, such as enhancing tax calculations by creating web scrapers, designing a new purchase order system, automating data retrieval for inventory reports, designing enhanced login systems for customers, and a range of other impactful initiatives.']
